...
# -- From file and experiments --
parser.add_argument('--env_config_file', type=str, default='',
                    help='read argumensts from a file')

config, _ = parser.parse_known_args()

# update the config object based on the env_config
if config.env_config_file != '':
    with open(config.env_config_file) as cf:
        env_config = json.loads(cf.read())
